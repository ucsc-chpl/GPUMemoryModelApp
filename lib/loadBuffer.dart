...
final String shader_spv = "assets/litmustest_load_buffer_default.spv";
final String result_spv = "assets/litmustest_load_buffer_results.spv";
final String param_basic = "assets/parameters_basic.txt";
final String param_stress = "assets/parameters_stress.txt";

class LoadBufferPage extends StatefulWidget {
  const LoadBufferPage({Key? key}) : super(key: key);

  @override
  State<LoadBufferPage> createState() => _LoadBufferPageState();
}

class _LoadBufferPageState extends State<LoadBufferPage> {
    final String _title = 'GPU Load Buffer Test';
    ...
    void _results([outputType]) {
        ...
        showDialog<String>(
            ...
            builder: (BuildContext context) => AlertDialog(
                    title: const Text('Load Buffer Test Results'),
    ...
    Widget build(BuildContext context) {
        final String title = 'GPU Load Buffer Test';
        final String page =
            "The load buffer litmus test checks to see if loads can be buffered and re-ordered on different threads. Variants using the release/acquire workgroup control barrier are also included.";
        final String init_state = "*x = 0, *y = 0";
        final String final_state = "r0 == 1 && r1 == 1";
        final String workgroup0_thread0_text1 =
            "0.1: let r0 = atomicLoad(y)";
        final String workgroup0_thread0_text2 =
            "0.2: atomicStore(x, 1)";
        final String workgroup1_thread0_text1 =
            "1.1: let r1 = atomicLoad(x)";
